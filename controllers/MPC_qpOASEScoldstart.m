classdef MPC_qpOASEScoldstart < handle
    ...
    %% methods
    methods
        function self = MPC_qpOASEScoldstart(Mdl, L, R, N, varargin)
            ...
            addParameter(p_ipt, 'max_cpu_time', 3);
            ...
            self.initialize_mpc(L, R, E_G, J_G, l_g, lb, ub, ...
                                p_ipt.Results.max_cpu_time);
        ...
        function u_vec = solve_mpc(self, x_k, d_vec_k, u_km1)
            ...
            [u_vec,fval,exitflag,iter,lambda,AuxOut] = qpOASES(self.H, h, ...
                self.G, self.lb, self.ub, [], g, self.qp_options);
            t = toc;
            % Timing
        ...
        function initialize_mpc(self,L,R,E_G,J_G,l_g,lb,ub,max_cpu_time)
            ...
            % qpOASES options
            self.qp_options = qpOASES_options('maxCpuTime', ...
                                              max_cpu_time/1000);
